...
const ShopWithSidebar = ({ products, total, itemsPerPage, title, desc }: { products: Product[], total: number, itemsPerPage: number, title: string, desc: string }) => {
          ...
          <div className="flex gap-7.5">
            ...
            <div className="xl:max-w-[870px] w-full">
              <div className="rounded-lg bg-white shadow-1 pl-3 pr-2.5 py-2.5 mb-6">
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex flex-wrap items-center gap-4">
                    ...
                    <p>
                      نمایش <span className="text-dark">{from} تا {to} از {total}</span>{" "}
                      محصول
                    </p>
                  </div>
              ...
              >
                ...
                {paginatedProducts.length === 0 && <div>محصولی برای نمایش وجود ندارد.</div>}
