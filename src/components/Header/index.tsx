...
const Header = () => {
  ...
  return (
    <header
      className={`fixed right-0 top-0 w-full z-9999 bg-white transition-all ease-in-out duration-300 ${
        stickyMenu && "shadow"
      }`}
    >
                ...
                <div className="flex items-center">
                  <div className="relative max-w-[333px] sm:min-w-[333px] w-full">
                    ...
                    <input
                      ...
                      autoComplete="off"
                      className="custom-search w-full rounded-r-[5px] bg-gray-1 !border-l-0 border border-gray-3 py-2.5 pr-4 pl-10 outline-none ease-in duration-200"
                    />

                    <button
                      id="search-btn"
                      aria-label="جستجو"
                      className="flex items-center justify-center absolute left-3 top-1/2 -translate-y-1/2 ease-in duration-200 hover:text-blue"
                    >
                      <svg
