...
const ShopDetails = () => {
  ...
  return (
    <>
      <Breadcrumb title={"جزئیات محصول"} pages={["جزئیات محصول"]} />

      {product.title === "" ? (
        "لطفاً محصول را اضافه کنید"
      ) : (
        <>
                    ...
                    <div className="flex flex-col gap-6">
                      <div className="rounded-xl bg-white shadow-1 p-4 sm:p-6">
                        ...
                        <p className="text-dark mt-6">
                          &ldquo;Lorem ipsum dolor sit amet, adipiscing elit. Donec
